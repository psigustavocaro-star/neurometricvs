...
export function FeaturesSection() {
    ...
    return (
        <section id="features" className="w-full py-24 md:py-32 bg-transparent dark:bg-slate-950 relative overflow-hidden transition-colors duration-300">
            ...
            <div className="absolute inset-0 bg-[linear-gradient(rgba(15,23,42,0.5)_1px,transparent_1px),linear-gradient(90deg,rgba(15,23,42,0.5)_1px,transparent_1px)] bg-[size:40px_40px] opacity-0 dark:opacity-20 transition-opacity duration-500" />

            {/* Section Header */}
            <div className="container px-4 md:px-6 mb-24 relative z-10 text-center">
                <ScrollAnimation>
                    ...
                    <h2 className="text-4xl md:text-7xl font-bold dark:font-light text-slate-900 dark:text-white tracking-tight dark:tracking-tighter mb-8 leading-tight">
                    ...
                    <p className="text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto leading-relaxed font-medium dark:font-light dark:tracking-wide">
                        {t('subtitle')}
                    </p>
                </ScrollAnimation>
            </div>

            <div className="container px-4 relative z-10 space-y-40">
                {features.map((feature, index) => (
                    <ScrollAnimation key={feature.key} viewport={{ once: false, margin: "-100px" }}>
                        <div className={`flex flex-col lg:flex-row items-center gap-20 ${feature.alignment === 'right' ? 'lg:flex-row-reverse' : ''}`}>
                            ...
                            <div className="flex-1 w-full perspective-1000 flex justify-center items-center py-10">
                                {feature.component}
                            </div>
                        </div>
                    </ScrollAnimation>
